...
export default async function DashboardPage({ searchParams }: Props) {
  ...
  const [{ staleTalents, summary, workItems }, searchResults] = await Promise.all([
    getDashboardData(),
