...
export default async function ResourceDetailPage({ params, searchParams }: Props) {
  ...
  return <main className="p-5 md:p-8"><section className="mx-auto max-w-4xl">
    ...
    {message.notice === "contact-created" ? <p className="mt-5 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800" role="status">联系记录已保存。{message.statusUpdated === "1" ? "处理状态已自动更新。" : ""}</p> : null}
