...
export default async function ResourceProcessPage({ searchParams }: Props) {
  ...
  const progressPercent = currentPosition > 0
    ? Math.round((currentPosition / processableResources.length) * 100)
    : 0;
