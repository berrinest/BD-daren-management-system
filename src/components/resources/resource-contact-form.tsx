...
export function ResourceContactForm({ resourceId }: { resourceId: string }) {
  return <form action={createResourceContactRecord} className="mt-4 grid gap-4 rounded-xl border border-[#e4e9e6] bg-[#f8faf8] p-4 md:grid-cols-2">
    ...
    <div className="text-right md:col-span-2"><button className="rounded-lg bg-[#31594b] px-4 py-2.5 text-sm font-semibold text-white" type="submit">保存联系记录</button></div>
  </form>;
}
