...
import { TALENT_LEVEL_LABELS, TALENT_LEVELS, TALENT_PLATFORM_LABELS, TALENT_PLATFORMS, TALENT_STAGES, TALENT_STAGE_LABELS } from "@/lib/constants";
...
export function TalentImporter() {
  ...
  const preview = useMemo<PreviewRow[]>(() => rawRows.map((row, index) => {
    ...
    const candidate = {
      ...
      talent_level: matchValue(get("talent_level"), TALENT_LEVELS, TALENT_LEVEL_LABELS) || "B",
